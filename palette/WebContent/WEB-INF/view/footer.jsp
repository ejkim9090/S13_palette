...
<div id="footer">
        <div class="f_f">
            <div class="f_f_1">
                <div class="f_f_1_1">
                    ...
                    <div>비회원 문의 : <a href="#">help@palettecorp.com</a>
                        <br>비회원 대량주문 문의 : <a href="#">palettegift@palettecorp.com</a>
                    </div>
                </div>
                <div class="f_f_1_2">
                    <ul>
                        <li><a>Palette소개</a></li>
                        <li><a>Palette소개영상</a></li>
                        <li><a>인재채용</a></li>
                        <li><a>이용약관</a></li>
                        <li><a>개인정보처리방침</a></li>
                        <li><a>이용안내</a></li>
                    ...
                    <div>
                        법인명 (상호) : 주식회사 Palette | 사업자등록번호 : 261-81-23567 <a>사용자정보 확인</a>
                        <br>통신판매업 : 제 2018-서울강남-01646 호 | 개인정보보호책임자 : 이원준
                        <br>주소 : 서울특별시 강남구 테헤란로 133, 18층(역삼동) | 대표이사 : 김슬아
                        <br>입점문의 : <a>입점문의하기</a> | 제휴문의 : <a>business@palettecorp.com</a>
                        <br>채용문의 : <a>recruit@palettecorp.com</a>
                        <br>팩스 : 070 - 7500 - 6098
                    </div>
                    <ul>
        ...
        <div class="f_f_2">
            <button>
                ...
                <p>[인증범위] 쇼핑몰 서비스 개발 · 운영<br>(심사받지 않은 물리적 인프라 제외)<br>[유효기간] 2022.01.19 ~ 2025.01.18</p>
            </button>
            <button>
    ...
    <div class="f_s">
        <p>판매되는 상품 중에는 입점한 개별 판매자가 판매하는 마켓플레이스(오픈마켓) 상품이 포함되어 있습니다.
