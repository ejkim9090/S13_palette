...
$(function() {
    ...
    // 상품 클릭시
    $(".m_s_1_list_1").attr("onclick","location.href='./product?pid=${pid}';");

    $(".m_s_4_list_1_product_1_content").attr("onclick","location.href='./product?pid=${pid}';");
    $(".m_s_4_list_1_product_1_img > img").attr("onclick","location.href='./product?pid=${pid}';");
    $(".m_s_4_list_1_product_1_button").attr("onclick","location.href='./shopping_basket.jsp';");

    $(".m_s_5_list_1_product_1_content").attr("onclick","location.href='./product?pid=${pid}';");
    $(".m_s_5_list_1_product_1_img > img").attr("onclick","location.href='./product?pid=${pid}';");
    $(".m_s_5_list_1_product_1_button").attr("onclick","location.href='./shopping_basket.jsp';");
